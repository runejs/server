...
import { findMusicTrack, findSongIdByRegionId, musicRegions } from '@server/config/index';
...
export class Player extends Actor {
  ...
  public playSong(songId: number): void {
      this.modifyWidget(widgets.musicPlayerTab, { childId: 177, text: findMusicTrack(songId).songName, textColor: colors.green });
